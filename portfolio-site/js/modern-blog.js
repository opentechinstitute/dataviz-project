...
var demo = (function(window, undefined) {
  ...
  function init() {
    ...
    var pattern = Trianglify({
      ...
      variance: 1,
      stroke_width: 0.5,
      x_colors: ['#37b4a5','#7ACBC5','#5BA4DA'],//,'#4D3969','#FDBF5C','#989392','#5368B0','#f2d55b','#444445','#1072B9','#9C2524','#2E9F99','#56A34A'],
      y_colors: ['#37b4a5','#7ACBC5','#5BA4DA']//,'#4D3969','#FDBF5C','#989392','#5368B0','#f2d55b','#444445','#1072B9','#9C2524','#2E9F99','#56A34A']
    }).svg(); // Render as SVG.
